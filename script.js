...
})(
    {
                    ...
                    return {
                        ...
                        each: function (obj, itr, scope) {
                            if (ARR_EACH && obj.forEach === ARR_EACH) {
                                ...
                                for (
                                    var key = 0, l = obj.length;
                                    key < l;
                                    key++
                                )
                                    if (
                                        key in obj &&
                                        itr.call(scope, obj[key], key) ===
                                            this.BREAK
                                    )
                                        return;
                            } else {
                    ...
                    Object.defineProperty(Color.prototype, "hex", {
                        get: function () {
                            if (!this.__state.space !== "HEX") {
                                this.__state.hex = math.rgb_to_hex(
                                    this.r,
                                    this.g,
                                    this.b
                                );
        ...
        3: [
            function (require, module, exports) {
                ...
                dat.dom.dom = (function (common) {
                    ...
                    var dom = {
                        ...
                        makeSelectable: function (elem, selectable) {
                            ...
                            elem.style.MozUserSelect = selectable
                                ? "auto"
                                : "none";
                            elem.style.KhtmlUserSelect = selectable
                                ? "auto"
                                : "none";
                        ...
                        fakeEvent: function (elem, eventType, params, aux) {
                            ...
                            switch (className) {
                                case "MouseEvents":
                                    var clientX =
                                        params.x || params.clientX || 0;
                                    var clientY =
                                        params.y || params.clientY || 0;
                                    evt.initMouseEvent(
                                        eventType,
                ...
                dat.controllers.OptionController = (function (
                    Controller,
                    dom,
                    common
                ) {
                    ...
                    var OptionController = function (
                        ...
                        OptionController.superclass.call(
                            this,
                            object,
                            property
                        );
                    ...
                    common.extend(
...

                        {
                            setValue: function (v) {
                                var toReturn =
                                    OptionController.superclass.prototype.setValue.call(
                                        this,
                                        v
                                    );
                ...
                dat.controllers.NumberController = (function (
                    ...
                    var NumberController = function (object, property, params) {
                        NumberController.superclass.call(
                            this,
                            object,
                            property
                        );
                ...
                dat.controllers.NumberControllerBox = (function (
                     ...
                     * @member dat.controllers
                     */
                    var NumberControllerBox = function (
                        object,
                        property,
                        params
                    ) {
                        ...
                        NumberControllerBox.superclass.call(
                            this,
                            object,
                            property,
                            params
                        ...
                        function onMouseDrag(e) {
                            ...
                            _this.setValue(
                                _this.getValue() + diff * _this.__impliedStep
                            );
                ...
                dat.controllers.NumberControllerSlider = (function (
                    ...
                    var NumberControllerSlider = function (
                        ...
                        NumberControllerSlider.superclass.call(
                            this,
                            object,
                            property,
                ...
                dat.controllers.FunctionController = (function (
                    ...
                    var FunctionController = function (object, property, text) {
                        FunctionController.superclass.call(
                            this,
                            object,
                            property
                        );
                ...
                dat.controllers.BooleanController = (function (
                    ...
                    var BooleanController = function (object, property) {
                        BooleanController.superclass.call(
                            this,
                            object,
                            property
                        );
                    ...
                    common.extend(
...

                        {
                            setValue: function (v) {
                                var toReturn =
                                    BooleanController.superclass.prototype.setValue.call(
                                        this,
                                        v
                                    );
                                if (this.__onFinishChange) {
                ...
                dat.GUI = dat.gui.GUI = (function (
                    ...
                    var GUI = function (params) {
                        ...
                        if (
                            params.autoPlace &&
                            common.isUndefined(params.scrollable)
                        ) {
                        ...
                        var use_local_storage =
                            ...
                            localStorage.getItem(
                                getLocalStorageHash(this, "isLocal")
                            ) === "true";
                        ...
                        if (common.isUndefined(params.parent)) {
                            ...
                            var title_row_name = document.createTextNode(
                                params.name
                            );
                        ...
                        if (params.autoPlace) {
                            if (common.isUndefined(params.parent)) {
                                ...
                                auto_place_container.appendChild(
                                    this.domElement
                                );
                    ...
                    dom.bind(
                        ...
                        function (e) {
                            if (
                                ...
                                (e.which === HIDE_KEY_CODE ||
                                    e.keyCode == HIDE_KEY_CODE)
                            ) {
                                GUI.toggleHide();
                            }
                        },
                    ...
                    common.extend(
                        ...
                        /** @lends dat.gui.GUI */
                        {
                            ...
                            destroy: function () {
                                if (this.autoPlace) {
                                    auto_place_container.removeChild(
                                        this.domElement
                                    );
                                }
                            },
                            ...
                            addFolder: function (name) {
                                ...
                                if (
                                    ...
                                    new_gui_params.closed =
                                        this.load.folders[name].closed;
                            ...
                            onResize: function () {
                                ...
                                if (root.scrollable) {
                                    ...
                                    common.each(
                                        root.__ul.childNodes,
                                        function (node) {
                                            if (
                                                !(
                                                    root.autoPlace &&
                                                    node === root.__save_row
                                                )
                                            )
                                ...
                                if (root.__closeButton) {
                                    root.__closeButton.style.width =
                                        root.width + "px";
                                }
                            },
                            ...
                            remember: function () {
                                if (common.isUndefined(SAVE_DIALOGUE)) {
                                    ...
                                    SAVE_DIALOGUE.domElement.innerHTML =
                                        saveDialogueContents;
                                }
                                ...
                                common.each(
                                    ...
                                    function (object) {
                                        if (
                                            _this.__rememberedObjects.length ==
                                            0
                                        ) {
                                            addSaveMenu(_this);
                                        }
                                        if (
                                            _this.__rememberedObjects.indexOf(
                                                object
                                            ) == -1
                                        ) {
                                            _this.__rememberedObjects.push(
                                                object
                                            );
                                        }
                                    }
                            ...
                            getSaveObject: function () {
                                ...
                                if (this.__rememberedObjects.length > 0) {
                                    ...
                                    toReturn.remembered[this.preset] =
                                ...
                                common.each(
                                    ...
                                    function (element, key) {
                                        toReturn.folders[key] =
                                            element.getSaveObject();
                                    }
                                );
                            ...
                            saveAs: function (presetName) {
                                ...
                                this.load.remembered[presetName] =
                                    getCurrentPreset(this);
                    ...
                    function add(gui, object, property, params) {
                        ...
                        if (params.color) {
                            ...
                            var factoryArgs = [object, property].concat(
                                params.factoryArgs
                            );
                            controller = controllerFactory.apply(
                                gui,
                                factoryArgs
                            );
                        }
                    ...
                    function augmentController(gui, li, controller) {
                        ...
                        if (controller instanceof NumberControllerSlider) {
                            ...
                            controller.updateDisplay = common.compose(function (
                                r
                            ) {
                                li.style.borderLeftColor =
                                    controller.__color.toString();
                                return r;
                            },
                        ...
                        if (matched_index != -1) {
                            ...
                            if (root.load && root.load.remembered) {
                                ...
                                if (preset_map[gui.preset]) {
                                    ...
                                    preset_map[DEFAULT_DEFAULT_PRESET_NAME]
                                ) {
                    ...
                    function addSaveMenu(gui) {
                        ...
                        dom.bind(select, "change", function () {
                            for (
                                var index = 0;
                                index < gui.__preset_select.length;
                                index++
                            ) {
                        ...
                        if (SUPPORTS_LOCAL_STORAGE) {
                            ...
                            if (
                                localStorage.getItem(
                                    getLocalStorageHash(gui, "isLocal")
                                ) === "true"
                            ) {
                                localStorageCheckBox.setAttribute(
                                    "checked",
                                    "checked"
                                );
                            }
                        ...
                        dom.bind(
                            newConstructorTextArea,
                            "keydown",
                            function (e) {
                                if (
                                    e.metaKey &&
                                    (e.which === 67 || e.keyCode == 67)
                                ) {
                                    SAVE_DIALOGUE.hide();
                                }
                            }
                    ...
                    function getCurrentPreset(gui, useInitialValues) {
                        ...
                        common.each(
                            ...
                            function (val, index) {
                                ...
                                var controller_map =
                                    gui.__rememberedObjectIndecesToControllers[
                                        index
                                    ];
                    ...
                    function setPresetSelectIndex(gui) {
                        for (
                            ...
                            if (
                                gui.__preset_select[index].value == gui.preset
                            ) {
                    ...
                    (dat.controllers.factory = (function (
                        ...
                        (dat.controllers.StringController = (function (
                            ...
                            var StringController = function (object, property) {
                                StringController.superclass.call(
                                    this,
                                    object,
                                    property
                                );
                    ...
                    (dat.controllers.ColorController = (function (
                        ...
                        var ColorController = function (object, property) {
                            ColorController.superclass.call(
                                this,
                                object,
                                property
                            );
                        ...
                        (dat.color.Color = (function (
                            ...
                            function recalculateHSV(color) {
                                ...
                                if (!common.isNaN(result.h)) {
                                    ...
                                    common.isUndefined(color.__state.h)
                                ) {
                                    color.__state.h = 0;
                                }
                            }
                            ...
                            (dat.color.math = (function () {
                                ...
                                return {
                                    ...
                                    rgb_to_hex: function (r, g, b) {
                                        var hex = this.hex_with_component(
                                            0,
                                            2,
                                            r
                                        );
                                        hex = this.hex_with_component(
                                            hex,
                                            1,
                                            g
                                        );
    ...
    */
        ...
        8: [
            function (require, module, exports) {
                var now = require(5),
                    ...
                    caf =
                        global["cancel" + suffix] ||
                        global["cancelRequest" + suffix];

                for (var i = 0; i < vendors.length && !raf; i++) {
                    raf = global[vendors[i] + "Request" + suffix];
                    caf =
                        global[vendors[i] + "Cancel" + suffix] ||
                ...
                var Stats = function () {
                    ...
                    function createPanel(id, fg, bg) {
                        var div = createElement(
                            "div",
                            id,
                            "padding:0 0 3px 3px;text-align:left;background:" +
                                bg
                        );
                        ...
                        var graph = createElement(
                            "div",
                            id + "Graph",
                            "width:74px;height:30px;background:" + fg
                        );
                        ...
                        for (var i = 0; i < 74; i++) {
                            graph.appendChild(
                                createElement(
                                    "span",
                                    "",
                                    "width:1px;height:30px;float:left;opacity:0.9;background:" +
                                        bg
                                )
                            );
                        }
        ...
        14: [
            function (require, module, exports) {
                ...
                function init() {
                    ...
                    var mesh = (exports.mesh = new THREE.Mesh(
                        geometry,
                        planeMaterial
                    ));
        ...
        15: [
            function (require, module, exports) {
                ...
                function init() {
                    ...
                    pointLight = exports.pointLight = new THREE.PointLight(
                        0xffffff,
                        1,
                        700
                    );
        ...
        16: [
            function (require, module, exports) {
                ...
                function _createTriangleMesh() {
                    ...
                    geometry.addAttribute(
                        "fboUV",
                        new THREE.BufferAttribute(fboUV, 2)
                    );
                ...
                function update(dt) {
                    ...
                    for (var i = 0; i < 2; i++) {
                        mesh = _meshes[i];
                        var lightPos =
                            mesh.customDistanceMaterial.uniforms.lightPos.value;
        ...
        17: [
            function (require, module, exports) {
                ...
                var TEXTURE_WIDTH = (exports.TEXTURE_WIDTH =
                ...
                function update(dt) {
                    ...
                    _positionShader.uniforms.attraction.value =
                        settings.attraction;
                    _positionShader.uniforms.initAnimation.value =
                        exports.initAnimation;

                    if (settings.followMouse) {
                        _positionShader.uniforms.mouse3d.value.copy(
                            settings.mouse3d
                        );
                    } else {
                        ...
                        _positionShader.uniforms.mouse3d.value.lerp(
                            _followPoint,
                            0.2
                        );
                    }
        ...
        20: [
            function (require, module, exports) {
                var isMobile = /(iPad|iPhone|Android)/i.test(
                    navigator.userAgent
                );
        ...
        21: [
            function (require, module, exports) {
                ...
                var glslifyGlobalRegExp =
                    /GLOBAL_VAR_([^_\.\)\;\,\s]+)(_\d+)?/g;
        ...
        22: [
            function (require, module, exports) {
                ...
                function init() {
                    ...
                    simulatorGui
                        .add(settings, "followMouse")
                        .name("follow mouse");

                    var renderingGui = _gui.addFolder("rendering");
                    renderingGui
                        .add(settings, "shadowDarkness", 0, 1)
                        .name("shadow");
                    renderingGui
                        .add(settings, "useTriangleParticles")
                        .name("new particle");
                    renderingGui
                        .addColor(settings, "color1")
                        .name("base Color");
                    renderingGui
                        .addColor(settings, "color2")
                        .name("fade Color");
                    renderingGui
                ...
                function _render(dt) {
                    ...
                    _control.maxDistance =
                        _initAnimation === 1
                            ...
                            : math.lerp(
                                  1000,
                                  450,
                                  ease.easeOutCubic(_initAnimation)
                              );
                    _control.update();
                    ...
                    _ray.origin.add(
                        _ray.direction.multiplyScalar(distance * 1.0)
                    );
                    simulator.update(dt);
                    particles.update(dt);

                    ratio = Math.min(
                        (1 - Math.abs(_initAnimation - 0.5) * 2) * 1.2,
                        1
                    );
                    var blur = (1 - ratio) * 10;
        ...
        24: [
            function (require, module, exports) {
                ...
                exports.upClampedUnMix = exports.unClampedUnLerp =
                    upClampedUnMix;
                exports.fract = fract;
                exports.hash = hash;
                exports.hash2 = hash2;
                ...
                function hash2(val1, val2) {
                    return fract(
                        Math.sin(val1 * 12.9898 + val2 * 4.1414) * 43758.5453
                    );
                }
